...
private:
	...
	{
		bool ret = false;
		if ((uintptr_t) freeEntry >= (uintptr_t)_firstUnAlignmentFreeEntry) {
			ret = true;
		}
		return ret;
	}
...
public:
	...
	{
		_firstUnAlignmentFreeEntry = (NULL == _heapFreeList) ? (MM_HeapLinkedFreeHeader *) UDATA_MAX : _heapFreeList;
