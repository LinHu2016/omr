...
//void
//MM_MemoryPoolBumpPointer::abandonMemoryInPool(MM_EnvironmentBase* env, void* address, uintptr_t size)
//{
//	void *addrBase = address;
//	void *addrTop = (void *)((uintptr_t)address + size);
//	Assert_MM_true(addrTop >= addrBase);
//	internalRecycleHeapChunk(addrBase, addrTop, NULL);
//}
