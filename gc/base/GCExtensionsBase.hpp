...
/* OMR_GC_REALTIME (in for all) */
	...
	uintptr_t bufferedLoggingSize; /**< Set by -Xgc:bufferedLoggingSize=nn (default = 2KB/2048, nn >= 2), bufferSize for writing logs, only be used when bufferedLogging == true  */
