...
public:
	 ...
	 * @return true if key associated to dataPtr is removed successfully, false otherwise
	 */
	bool verifyAndUnmapSparseDataPtrFromHeapProxyObjectPtr(void *dataPtr, void *proxyObjPtr, uintptr_t size);
	 ...
	 * @return true if the sparse data entry was successfully updated, false otherwise
	 */
	bool verifyAndUpdateSparseDataEntryAfterObjectHasMoved(void *dataPtr, void *proxyObjPtr, uintptr_t size, void *newProxyObjPtr);
...
private:
	 ...
	 * @return true if data pointer is valid
	 */
	bool verifySparseDataEntry(MM_SparseDataTableEntry *entry, void *dataPtr, void *proxyObjPtr, uintptr_t size);
